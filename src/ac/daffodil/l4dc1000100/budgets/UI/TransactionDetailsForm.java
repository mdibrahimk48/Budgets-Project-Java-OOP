...
import static ac.daffodil.l4dc1000100.budgets.UI.DataManager.TransactionDataManager.balanceUpdate;
import ac.daffodil.l4dc1000100.budgets.UI.bean.TransactionTable;
import ac.daffodil.l4dc1000100.budgets.UI.TransactionTable.TransactionTableModel;
...
public class TransactionDetailsForm extends javax.swing.JInternalFrame {
    ...
    public TransactionDetailsForm() {
        ...
        totalTextField.setText(String.valueOf(transactionTableModel.getTotal()));
        
        transactionInformationTable.getSelectionModel().addListSelectionListener(new ListSelectionListener(){
            @Override
            public void valueChanged(ListSelectionEvent lse) {
               int selectedRow = transactionInformationTable.getSelectedRow();
               if(selectedRow >=0){
                   TransactionTable transactionTableDetails = transactionTableModel.getTransactionTable(selectedRow);
                   if(transactionTableDetails != null){
                       
                        dateChooser.setDate(transactionTableDetails.getDate());
                        categoryComboBox.setSelectedItem(transactionTableDetails.getCategory());
                        accountComboBox.setSelectedItem(transactionTableDetails.getAccount());
                        amountTextField.setText(transactionTableDetails.getAmount().toString());
                        payeeTextField.setText(transactionTableDetails.getPayee());
                        notesTextArea.setText(transactionTableDetails.getNote());
                   }
                }
            }   
        });
    ...
    private void initComponents() {
        ...
        transactionInformationTable = new javax.swing.JTable();

        setClosable(true);
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
        setTitle("Transaction Details Form");
        ...
        buttonPanel2.setBackground(new java.awt.Color(102, 204, 255));
        buttonPanel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));

        totalTextField.setFont(new java.awt.Font("Serif", 1, 12)); // NOI18N

        totalLabel.setFont(new java.awt.Font("Bodoni MT Black", 3, 14)); // NOI18N
        ...
        transactionInformationTable.setBackground(new java.awt.Color(102, 204, 255));
        transactionInformationTable.setBorder(new javax.swing.border.MatteBorder(null));
        transactionInformationTable.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        transactionInformationTable.setModel(transactionTableModel);
        transactionInformationTable.setRowHeight(25);
        transactionInformationTable.setRowMargin(2);
        jScrollPane2.setViewportView(transactionInformationTable);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(contentPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 708, Short.MAX_VALUE)
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        transactionTable.setId(UUID.randomUUID().toString());
        ...
        transactionTable.setDate(dateChooser.getDate());
        transactionTable.setCategory((CategoryTable)categoryComboBox.getSelectedItem());
        transactionTable.setAccount((AccountTable)accountComboBox.getSelectedItem());
        transactionTable.setAmount(Double.parseDouble(amountTextField.getText()));
        transactionTable.setPayee(payeeTextField.getText());
        transactionTable.setNote(notesTextArea.getText());

        
        transactionTableModel.addRow(transactionTable);
        
        TransactionDataManager.updateBalance(transactionTable, transactionTable.getAccount());
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        if(selectedRow >= 0){
            transactionTableModel.deleteRow(selectedRow);
            totalTextField.setText(String.valueOf(transactionTableModel.getTotal()));
            clear();
        }else{
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        TransactionTable transactionTable= transactionTableModel.getTransactionTable(selectedRow);
        transactionTable.setDate(dateChooser.getDate());
        transactionTable.setCategory((CategoryTable)categoryComboBox.getSelectedItem());
        transactionTable.setAmount(Double.parseDouble(amountTextField.getText()));
        transactionTable.setAccount((AccountTable)accountComboBox.getSelectedItem());
        ...
        transactionTableModel.updateRow(selectedRow, transactionTable);
        
        balanceUpdate(transactionTable);
    ...
    private javax.swing.JTable transactionInformationTable;
